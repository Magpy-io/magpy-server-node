...
const endpointsToTestInvalidToken: Array<{
  ...
  { endpoint: 'getPhotosByMediaId', func: exportedTypes.GetPhotosByMediaId.Post },
  { endpoint: 'updatePhotoMediaId', func: exportedTypes.UpdatePhotoMediaId.Post },
...
describe('Test endpoints return error when invalid token', () => {
  ...
  beforeEach(async () => {
    await sac.beforeEachLocalClaim(app);
  });
